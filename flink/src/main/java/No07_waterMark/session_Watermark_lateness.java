...
public class session_Watermark_lateness {
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream<Tuple2<String, Integer>, Tuple, TimeWindow> window =
                kb.window(EventTimeSessionWindows.withGap(Time.seconds(5)))
        ...
        //sensor_1,1547718206,35.8
        //sensor_1,1547718211,35.8
        //sensor_1,1547718218,35.8
