...
/**
 *  双流join 可以用Connect算子
 *  connect 可以实现左外 右外 全外连接
 *
 *  P143 - P145
 */

public class _13_支付到账_connect后keyBy {
    public static void main(String[] args) throws Exception {
        ...
        //todo 4. keyBy
        SingleOutputStreamOperator<Tuple2<OrderEvent, TxEvent>> result = connect.keyBy(
        ...
        ).process(new OrderReceiptKeyProFunc());
